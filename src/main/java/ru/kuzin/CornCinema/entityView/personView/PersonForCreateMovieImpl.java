...
@StaticImplementation(PersonForCreateMovie.class)
public class PersonForCreateMovieImpl implements PersonForCreateMovie, EntityViewProxy {
	
	public static volatile EntityViewManager ENTITY_VIEW_MANAGER;
	public static final SerializableEntityViewManager SERIALIZABLE_ENTITY_VIEW_MANAGER = new SerializableEntityViewManager(PersonForCreateMovieImpl.class, ENTITY_VIEW_MANAGER);

	private Integer personId;
	private Integer ampluaId;
	
	public PersonForCreateMovieImpl() {
		
	}
	
	public PersonForCreateMovieImpl(PersonForCreateMovieImpl noop, Map<String, Object> optionalParameters) {
		this.personId = null;
		this.ampluaId = null;
	}
	
	public PersonForCreateMovieImpl(Integer personId) {
		this.personId = personId;
		this.ampluaId = null;
	}
	
	public PersonForCreateMovieImpl(Integer personId, Integer ampluaId) {
		this.personId = personId;
		this.ampluaId = ampluaId;
	}
	
	public PersonForCreateMovieImpl(PersonForCreateMovieImpl noop, int offset, Object[] tuple) {
		this.personId = (Integer) tuple[offset + 1];
		this.ampluaId = (Integer) tuple[offset + 0];
	}
	...
	public Class<?> $$_getJpaManagedClass() {
		return PersonWithAmpluaForMovie.class;
	}
	...
	public Class<?> $$_getEntityViewClass() {
		return PersonForCreateMovie.class;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof PersonForCreateMovieImpl) {
			PersonForCreateMovieImpl other = (PersonForCreateMovieImpl) obj;
